        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[2fr_3fr] gap-14 lg:gap-20 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -right-5 w-28 h-28 bg-primary flex flex-col items-center justify-center text-primary-foreground text-center p-3">
              <span className="text-2xl" style={{ fontFamily: "'Lora', serif", fontWeight: 500 }}>15+</span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {services.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-background p-7 hover:bg-secondary transition-colors group cursor-default">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-[5fr_7fr] gap-14 lg:gap-20">
          <div>
            ...
            <div className="space-y-5">
              {[
                ...
                { icon: Mail, label: "Email", value: "drcarol@cherishconsulting.com", href: "mailto:drcarol@cherishconsulting.com" },
                { icon: MapPin, label: "Serving", value: "Tennessee & Virginia", href: undefined },
                ...
                const inner = (
                  <div className="flex items-center gap-4 group">
                    <div className="w-10 h-10 border border-border flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:border-primary transition-colors">
                      <Icon size={13} strokeWidth={1.5} className="text-foreground/50 group-hover:text-primary-foreground transition-colors" />
                    </div>
                    <div>
                      <p className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase mb-0.5">{label}</p>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase block mb-1.5">First Name</label>
                <input type="text" className="w-full border border-border bg-secondary px-3 py-2.5 text-sm focus:outline-none focus:border-primary transition-colors placeholder:text-foreground/30" placeholder="First" />
              </div>
              <div>
                <label className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase block mb-1.5">Last Name</label>
                <input type="text" className="w-full border border-border bg-secondary px-3 py-2.5 text-sm focus:outline-none focus:border-primary transition-colors placeholder:text-foreground/30" placeholder="Last" />
              </div>
            </div>
            <div>
              <label className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase block mb-1.5">Email</label>
              <input type="email" className="w-full border border-border bg-secondary px-3 py-2.5 text-sm focus:outline-none focus:border-primary transition-colors placeholder:text-foreground/30" placeholder="you@example.com" />
            </div>
            <div>
              <label className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase block mb-1.5">Area of Interest</label>
            ...
            <div>
              <label className="text-[9px] text-muted-foreground tracking-[0.2em] uppercase block mb-1.5">Message</label>
              <textarea rows={4} className="w-full border border-border bg-secondary px-3 py-2.5 text-sm focus:outline-none focus:border-primary transition-colors resize-none placeholder:text-foreground/30" placeholder="Tell us how we can help…" />
            </div>
            <button type="submit" className="w-full bg-primary text-primary-foreground py-3 text-xs tracking-widest uppercase hover:opacity-90 transition-opacity">Send Message</button>
          </form>
        </div>
      </section>
